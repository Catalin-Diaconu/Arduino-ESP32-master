...
/* Wifi Crdentials */
String sta_ssid = "Cata's Home";     // set Wifi network you want to connect to
String sta_password = "catalin1997";   // set password for Wifi network

//String sta_ssid = "Cata's PC";     // set Wifi network you want to connect to
//String sta_password = "12345678";   // set password for Wifi network
...
extern int IN3 = 13;
extern int IN4 = 12;
extern int gasPin = 16;
const char* index_html = "Initializing...";
...
void setup() {
  ...
  Serial.println();
  Serial.println("ESP32 Camera - Rescue Robot");
  Serial.println("-------------------------------------------------------");
  ...
  Serial.println();
  Serial.println("ESP32-CAM model: "+hostname);
  ...
  startCameraServer();
  Serial.println("Connected! Use 'http://");
  Serial.print(myIP);
...
void loop() {
  ...
  ArduinoOTA.handle();
  new1=digitalRead(gasPin);
  if(new1>0){
    index_html = "Scurgere de gaz detectata";
    
  }
  else {
    index_html = "Niciun pericol detectat";
  }
  delay(1000);
}
